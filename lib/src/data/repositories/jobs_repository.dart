...
final class JobsRepository {
  static final _jobs = <Job>[
    ...
    const Job(
      ...
      team: Team(name: 'Computer Science'),
      description:
          'Estamos contratando Desarrollador Mobile Flutter para uno de '
  ...
  void save(Job job, {required bool unique}) {
    final index = _jobs
        .indexWhere((j) => j.title.toLowerCase() == job.title.toLowerCase());
